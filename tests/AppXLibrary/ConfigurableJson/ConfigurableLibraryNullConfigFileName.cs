...
{
    public class ConfigurableLibraryNullConfigFileName : LibraryHandleBase, IConfigurableLibrary
    {
        #region Public Constructors

        public ConfigurableLibraryNullConfigFileName() : base("AppXLibrary.dll")
        {}
