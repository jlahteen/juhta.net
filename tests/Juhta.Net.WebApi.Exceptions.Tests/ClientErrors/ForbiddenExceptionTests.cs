...
namespace Juhta.Net.WebApi.Exceptions.Tests.ClientErrors
{
    ...
    public class ForbiddenExceptionTests : WebApiExceptionTests
    {
        ...
        [TestMethod]
        public void ThrowAndSerialize_ForbiddenException5_ShouldReturn()
        {
            ...
            try
            {
                ...
                throw new ForbiddenException(clientError);
            }
            ...
            catch (ForbiddenException ex)
            {
                AssertException(
                    ex,
                    "ThrowAndSerialize_ForbiddenException5_ShouldReturn",
                    HttpStatusCode.Forbidden,
                    "MyApiErrorCode.XYZ",
                    "Error XYZ occurred.",
                    "FormX.FieldY",
        ...
        [TestMethod]
        public void ThrowAndSerialize_ForbiddenException6_ShouldReturn()
        {
            ...
            try
            {
                ...
                throw new ForbiddenException(new ClientError[]{clientError1, clientError2});
            }
            ...
            catch (ForbiddenException ex)
            {
                AssertException(
                    ex,
                    "ThrowAndSerialize_ForbiddenException6_ShouldReturn",
                    HttpStatusCode.Forbidden,
                    "MyApiErrorCode.XYZ1",
                    "Error XYZ1 occurred.",
                    "FormX.FieldY1",
        ...
        [TestMethod]
        public void ThrowAndSerialize_ForbiddenException7_ShouldReturn()
        {
            ClientErrorResponse clientErrorResponse1, clientErrorResponse2;
            ForbiddenException exception1 = null, exception2 = null;
            ...
            try
            {
                throw new ForbiddenException(ErrorCode.InvalidOrderNumber, Field.CustomerName);
            }
            ...
            catch (ForbiddenException ex)
            {
                AssertException(
                    ex,
                    "ThrowAndSerialize_ForbiddenException7_ShouldReturn",
                    HttpStatusCode.Forbidden,
                    ErrorCode.InvalidOrderNumber.ToString(),
                    null,
        ...
        [TestMethod]
        public void ThrowAndSerialize_ForbiddenException8_ShouldReturn()
        {
            ClientErrorResponse clientErrorResponse1, clientErrorResponse2;
            ForbiddenException exception1 = null, exception2 = null;
            ...
            try
            {
                throw new ForbiddenException("This is an error, please consult the help URL.", "http://juhta.net/helpurls/353353");
            }
            ...
            catch (ForbiddenException ex)
            {
                AssertException(
                    ex,
                    "ThrowAndSerialize_ForbiddenException8_ShouldReturn",
                    HttpStatusCode.Forbidden,
                    null,
        ...
        [TestMethod]
        public void ThrowAndSerialize_ForbiddenException9_ShouldReturn()
        {
            ClientErrorResponse clientErrorResponse1, clientErrorResponse2;
            ForbiddenException exception1 = null, exception2 = null;
            ...
            try
            {
                throw new ForbiddenException(ErrorCode.InvalidOrderNumber, Field.CustomerName, "The field content is not allowed at all. Please do better.");
            }
            ...
            catch (ForbiddenException ex)
            {
                AssertException(
                    ex,
                    "ThrowAndSerialize_ForbiddenException9_ShouldReturn",
                    HttpStatusCode.Forbidden,
                    ErrorCode.InvalidOrderNumber.ToString(),
        ...
        [TestMethod]
        public void ThrowAndSerialize_ForbiddenException10_ShouldReturn()
        {
            ClientErrorResponse clientErrorResponse1, clientErrorResponse2;
            ForbiddenException exception1 = null, exception2 = null;
            ...
            catch (ForbiddenException ex)
            {
                AssertException(
                    ex,
                    "ThrowAndSerialize_ForbiddenException10_ShouldReturn",
                    HttpStatusCode.Forbidden,
                    ErrorCode.InvalidOrderNumber.ToString(),
        ...
        [TestMethod]
        public void ThrowAndSerialize_ForbiddenException11_ShouldReturn()
        {
            ClientErrorResponse clientErrorResponse1, clientErrorResponse2;
            ForbiddenException exception1 = null, exception2 = null;
