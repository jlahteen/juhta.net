...
namespace Juhta.Net.Startup
{
    ...
    internal class LibraryManager
    {
        ...
        /// be null.</param>
        public void InitializeLibraries(XmlNode librariesNode)
        {
            ILibraryHandle libraryHandle;
            string configFileName;

            // Return immediately if there is nothing to initialize
            ...
            {
                libraryHandle = CreateInstance(libraryNode);
        ...
        private ILibraryHandle CreateInstance(XmlNode libraryNode)
        {
