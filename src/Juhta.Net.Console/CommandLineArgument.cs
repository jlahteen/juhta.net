...
namespace Juhta.Net.Console
{
    ...
    public abstract class CommandLineArgument
    {
        ...
        public T GetValueAs<T>()
        {
            ...
            {
                throw new CommandLineArgumentException(LibraryMessages.Error001.FormatMessage(m_value, typeof(T)), ex);
            }
        }
        ...
        public T GetValueAs<T>(IValidator<T> validator)
        {
            ...
            {
                throw new CommandLineArgumentException(LibraryMessages.Error002.FormatMessage(m_value, validator.GetType()), ex);
            }
