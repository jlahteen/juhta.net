...
namespace Juhta.Net.WebApi.Exceptions.ClientErrorExceptions
{
    ...
    public class ProxyAuthenticationRequiredException : ClientErrorException
    {
        ...
        /// <param name="message">Specifies an error message.</param>
        /// <param name="helpUrl">Specifies a URL that provides extra information about the error.</param>
        public ProxyAuthenticationRequiredException(Enum errorCode, string message, string helpUrl) : base(HttpStatusCode.ProxyAuthenticationRequired, message, errorCode.ToString(), null, helpUrl)
        {}
