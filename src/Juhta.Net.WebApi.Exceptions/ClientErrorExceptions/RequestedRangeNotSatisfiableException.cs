...
namespace Juhta.Net.WebApi.Exceptions.ClientErrorExceptions
{
    ...
    public class RequestedRangeNotSatisfiableException : ClientErrorException
    {
        ...
        /// <param name="message">Specifies an error message.</param>
        /// <param name="helpUrl">Specifies a URL that provides extra information about the error.</param>
        public RequestedRangeNotSatisfiableException(Enum errorCode, string message, string helpUrl) : base(HttpStatusCode.RequestedRangeNotSatisfiable, message, errorCode.ToString(), null, helpUrl)
        {}
