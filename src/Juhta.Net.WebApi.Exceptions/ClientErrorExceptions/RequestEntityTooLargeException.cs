...
namespace Juhta.Net.WebApi.Exceptions.ClientErrorExceptions
{
    ...
    public class RequestEntityTooLargeException : ClientErrorException
    {
        ...
        /// <param name="message">Specifies an error message.</param>
        /// <param name="helpUrl">Specifies a URL that provides extra information about the error.</param>
        public RequestEntityTooLargeException(Enum errorCode, string message, string helpUrl) : base(HttpStatusCode.RequestEntityTooLarge, message, errorCode.ToString(), null, helpUrl)
        {}
