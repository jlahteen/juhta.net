...
namespace Juhta.Net.WebApi.Exceptions.ClientErrors
{
    ...
    public class ConflictException : ClientErrorException
    {
        ...
        /// <param name="field">Specifies a field to which the error relates.</param>
        /// <param name="message">Specifies an error message.</param>
        public ConflictException(Enum errorCode, string field, string message) : base(HttpStatusCode.Conflict, message, errorCode.ToString(), field, null)
        {}
        ...
        /// <param name="message">Specifies an error message.</param>
        /// <param name="helpUrl">Specifies a URL that provides extra information about the error.</param>
        public ConflictException(Enum errorCode, string field, string message, string helpUrl) : base(HttpStatusCode.Conflict, message, errorCode.ToString(), field, helpUrl)
        {}
