...
namespace Juhta.Net.WebApi.Exceptions.ClientErrors
{
    ...
    public class NotFoundException : ClientErrorException
    {
        ...
        public NotFoundException(Enum errorCode) : base(HttpStatusCode.NotFound, null, errorCode.ToString())
        {}
        ...
        /// <param name="errorCode">Specifies a custom defined error code.</param>
        /// <param name="message">Specifies an error message.</param>
        public NotFoundException(Enum errorCode, string message) : base(HttpStatusCode.NotFound, message, errorCode.ToString())
        {}
