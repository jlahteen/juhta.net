...
namespace Juhta.Net.WebApi.Exceptions.ClientErrorExceptions
{
    ...
    public class BadRequestException : ClientErrorException
    {
        ...
        public BadRequestException(ClientError clientError) : base(HttpStatusCode.BadRequest, clientError)
        {}
        ...
        public BadRequestException(IEnumerable<ClientError> clientErrors) : base(HttpStatusCode.BadRequest, clientErrors)
        {}
        ...
        public BadRequestException(string message, string helpUrl) : base(HttpStatusCode.BadRequest, message, null, null, helpUrl)
        {}
        ...
        /// <param name="field">Specifies a field to which the error relates.</param>
        /// <param name="message">Specifies an error message.</param>
        public BadRequestException(Enum errorCode, string field, string message) : base(HttpStatusCode.BadRequest, message, errorCode.ToString(), field, null)
        {}
        ...
        /// <param name="message">Specifies an error message.</param>
        /// <param name="helpUrl">Specifies a URL that provides extra information about the error.</param>
        public BadRequestException(Enum errorCode, Enum field, string message, string helpUrl) : base(HttpStatusCode.BadRequest, message, errorCode.ToString(), field.ToString(), helpUrl)
        {}
        ...
        /// <param name="message">Specifies an error message.</param>
        /// <param name="helpUrl">Specifies a URL that provides extra information about the error.</param>
        public BadRequestException(Enum errorCode, string field, string message, string helpUrl) : base(HttpStatusCode.BadRequest, message, errorCode.ToString(), field, helpUrl)
        {}
