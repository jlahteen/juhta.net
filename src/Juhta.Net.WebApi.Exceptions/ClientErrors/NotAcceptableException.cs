...
namespace Juhta.Net.WebApi.Exceptions.ClientErrors
{
    ...
    public class NotAcceptableException : ClientErrorException
    {
        ...
        public NotAcceptableException(Enum errorId) : base(HttpStatusCode.BadRequest, null, errorId.ToString())
        {}
        ...
        /// <param name="errorId">Specifies a custom defined error identifier.</param>
        /// <param name="message">Specifies an error message.</param>
        public NotAcceptableException(Enum errorId, string message) : base(HttpStatusCode.BadRequest, message, errorId.ToString())
        {}
