...
namespace Juhta.Net.WebApi.Exceptions.ServerErrors
{
    ...
    public class NotImplementedException : ServerErrorException
    {
        ...
        public NotImplementedException(string message, Exception innerException) : base(HttpStatusCode.NotImplemented, message, innerException)
        {}
        ...
        internal NotImplementedException(ServerErrorResponse serverErrorResponse) : base(serverErrorResponse)
        {}
