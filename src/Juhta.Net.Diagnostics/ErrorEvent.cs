...
{
    /// <summary>
    /// Defines a class for error events.
    /// </summary>
    internal class ErrorEvent : Event
    {
        ...
        public ErrorEvent(string message) : base(EventType.Error, message)
        {}
        ...
        public ErrorEvent(string message, string id) : base(EventType.Error, message, id)
        {}
